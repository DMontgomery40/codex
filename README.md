...
```shell
# Install this fork via script (Agent Teams docs/tools in this fork)
curl -fsSL https://raw.githubusercontent.com/DMontgomery40/codex/main/scripts/install/install.sh | sh
```
